...
2. **Save** your changes. 5.. Add images to the profile of some website users. Alternatively use the _Generate users_ function (**Configuration** → **Development** → **Generate users**).
3. Change the authors of existing content so we have a variety of authors. Edit the “Authoring information” tab in the existing _News and Media_ and _Job postings_.
...
1.  Click the **Edit** button in the Sidebar Right (2:1) row
    ...
    <img src="../.gitbook/assets/115 (1) (1) (1) (1) (1) (1) (1).png" alt="Image of Edit Sidebar Right" data-size="original">
